...
public class IntergenicAnnotation {
	...
	public static Annotation createUpDownstreamAnnotation(TranscriptModel trmdl, int pos) throws JannovarException {
		...
		if (trmdl == null) {
			LOG.error("createUpDownstreamAnnotation, TranscriptModel argument is null, pos=" + pos);
            throw new JannovarException("createUpDownstreamAnnotation, TranscriptModel argument is null, pos=" + pos);
		}
		int dist = 0;
