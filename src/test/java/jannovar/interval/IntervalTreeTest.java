...
public class IntervalTreeTest {
	...
	public List<Interval<String>> randomList() throws JannovarException {
		...
		for (int index = 0; index < 5000; index++) {
			...
			Interval<String> interval = new Interval<String>(rLow, rHigh, "value " + index);
	...
	public List<Interval<String>> getIntervalList1() throws JannovarException {
		...
		Interval<String> iC = new Interval<String>(4, 7, "c");
		Interval<String> iD = new Interval<String>(5, 6, "d");
		Interval<String> iE = new Interval<String>(16, 19, "e");
		Interval<String> iF = new Interval<String>(11, 15, "f");
		Interval<String> iG = new Interval<String>(30, 66, "g");
		ilist.add(iA);
		ilist.add(iB);
		ilist.add(iC);
		ilist.add(iD);
	...
	public List<Interval<String>> getIntervalList2() throws JannovarException {
		...
		ilist.add(new Interval<String>(4, 11, "c"));
		ilist.add(new Interval<String>(7, 12, "e"));
		ilist.add(new Interval<String>(9, 19, "f"));
		ilist.add(new Interval<String>(16, 19, "g"));
		ilist.add(new Interval<String>(17, 20, "h"));

		ilist.add(new Interval<String>(26, 30, "i"));
		ilist.add(new Interval<String>(27, 29, "j"));
