...
public class SynonymousAnnotationTest implements Constants {
	...
	/**
	 * <P>
	 * annovar: RNF207:uc001amg.3:exon17:c.1718A>G:p.N573S, chr1:6278414A>G
	 * expected:<...uc011mzv.2:exon12:c.[A1060T:p.T354S
	...
	/**
	 * <P>
	 * annovar: UBR4:uc001bbi.3:exon68:c.9981G>C:p.L3327L,UBR4:uc001bbk.1:exon21:c.2922G>C:p.L974L, chr1:19447843C>G
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: HMGB4:uc021oky.1:exon1:c.105T>C:p.Y35Y,HMGB4:uc001bxp.3:exon2:c.105T>C:p.Y35Y, chr1:34329897T>C This is
	 * synonymous, HMGB4(uc001bxp.3:exon2:c.105T>C:p.Y35Y,uc021oky.1:exon1:c.105T>C:p.Y35Y) but there is another isoform
	 * that is UTR5, which gets correctly prioritized by Jannovar This is: uc001bxq.3 chr1 + 34329679 34330392 34330014
	 * 34330353 2 34329679,34329863, 34329778,34330392, Q8WW32 uc001bxq.3 That is, startCDS=34330014 (located in exon 2)
	 * The variant 34329897 is also located in exon 2. This rvarstart is position = 34330014 - 34329897 +1 = 117
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: MRPS15:uc001cas.2:exon3:c.207C>T:p.P69P, chr1:36927733G>A
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: FRRS1:uc001dsh.1:exon7:c.708C>T:p.S236S, chr1:100203693G>A
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: CELSR2:uc001dxa.4:exon1:c.1551T>C:p.S517S, chr1:109794252T>C
	 * </P>
	 */
	@Test
	 ...
	 * <P>
	 * annovar:
	 * DDX20:uc001ebs.3:exon11:c.1926G>A:p.V642V,DDX20:uc010owf.2:exon10:c.1212G>A:p.V404V,DDX20:uc001ebt.3:exon3
	 * :c.750G>A:p.V250V, chr1:112308972G>A
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: HRNR:uc001ezt.1:exon3:c.814C>A:p.R272R, chr1:152193291G>T
	 * </P>
	 */
	@Test
	 ...
	 * <P>
	 * annovar:
	 * GORAB:uc001ggz.4:exon1:c.96A>C:p.G32G,GORAB:uc001gha.2:exon1:c.96A>C:p.G32G,GORAB:uc009wvw.2:exon1:c.96A>
	 ...
	 *       Assert.assertEquals(VariantType.SYNONYMOUS,varType); String annot = ann.getVariantAnnotation();
	 *       Assert.assertEquals
	 *       ("GORAB(uc001ggz.4:exon1:c.96A>C:p.G32G,uc001gha.2:exon1:c.96A>C:p.G32G,uc009wvw.2:exon1:c.96A>C:p.G32G)"
	 *       ,annot); } }
	 */
	 ...
	 * <P>
	 * annovar:
	 * DNM3:uc001gih.1:exon2:c.291A>G:p.T97T,DNM3:uc001gif.3:exon18:c.2211A>G:p.T737T,DNM3:uc001gie.3:exon19:c.2223
	 * A>G:p.T741T, chr1:172356437A>G
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: LAMC1:uc001gpy.4:exon25:c.4128T>C:p.R1376R, chr1:183105534T>C
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: RNPEP:uc001gxd.3:exon6:c.1143G>A:p.Q381Q,RNPEP:uc001gxe.3:exon5:c.246G>A:p.Q82Q, chr1:201969082G>A
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: HHIPL2:uc001hnh.1:exon1:c.99G>A:p.L33L, chr1:222721288C>T
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: AGR2:uc003str.3:exon7:c.441T>C:p.N147N, chr7:16834597A>G
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: HDAC9:uc003suh.3:exon23:c.3030C>T:p.F1010F, chr7:18993870C>T
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: ZNF680:uc003tta.2:exon4:c.1569T>C:p.C523C, chr7:63981563A>G
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: KPNA7:uc010lft.2:exon7:c.936G>A:p.T312T, chr7:98782750C>T
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: DGKI:uc003vtt.3:exon29:c.2778A>G:p.E926E,DGKI:uc003vtu.3:exon28:c.1785A>G:p.E595E, chr7:137128830T>C
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: CCDC94:uc002lzv.4:exon3:c.171T>C:p.N57N, chr19:4251069T>C
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: MUC16:uc002mkp.3:exon1:c.1284A>G:p.E428E, chr19:9090531T>C
	 * </P>
	 */
	@Test
	...
	/**
	 * <P>
	 * annovar: MYH9:uc003apg.3:exon26:c.3429T>G:p.A1143A, chr22:36691607A>C
	 * </P>
	 */
	@Test
